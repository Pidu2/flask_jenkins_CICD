  ...
  stages {
    ...
    stage("deploy") {
      steps{
        ...
        sh 'wget https://releases.hashicorp.com/terraform/0.15.0/terraform_0.15.0_linux_amd64.zip;unzip terraform_0.15.0_linux_amd64.zip;rm terraform_0.15.0_linux_amd64.zip' 
